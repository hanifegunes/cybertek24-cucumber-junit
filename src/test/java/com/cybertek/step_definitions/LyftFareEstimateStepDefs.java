...
public class LyftFareEstimateStepDefs {
    ...
    public void user_enters_to_drop_address(String dropOffLocation) {
      ...
      //  fareEstimatePage.enterDropOffLocation(dropOffLocation);
    ...
    public void user_clicks_on_get_estimate_button() {
      ...
      //  actions.moveToElement(fareEstimatePage.getEstimate).doubleClick().build().perform();

    fareEstimatePage.getEstimateBtn.sendKeys(Keys.ENTER);
    ...
    public void userShouldSeeErrorMessage() {
       // fareEstimatePage.errorMsg.isDisplayed();
